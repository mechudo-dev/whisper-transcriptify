...
const Navbar = () => {
  return (
    <div className='z-50 top-0 inset-x-0 items-center  w-full flex justify-between p-2 fixed backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b'>
